...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //
        // 여기서 껍데기가 직접 민다. 웹의 env(safe-area-inset-*) 로는 안 된다.
        // 안드로이드 WebView 는 그 값에 디스플레이 컷아웃(노치)만 담고 상태바
        // 높이는 담지 않는다. iOS 사파리와 다른 점이고, 노치 없는 기기에서는
        // 0 이 나온다. 실제로 그걸로 고치려다 한 번 헛수고했다.
        //
        // 잰 값은 lastInsets 에 남겨 두고 브리지의 insets() 로 웹에 알려 준다.
        // 화면에 숫자로 띄워 두면 다음에 또 겹칠 때 추측하지 않아도 된다.
